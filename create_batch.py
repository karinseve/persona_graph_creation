...
class Corpus:
    ...
    def get_validation_pred(self, args, model, unique_entities):
        ...
        for iters in range(1):
            ...
            id_entity_list = {j: i for i, j in self.id2entity.items()}
            ...
            for i in range(batch_indices.shape[0]):
                ...
                #     print('Not passing continue')
                #     continue

                print('Passed continue...')
                left_entity = batch_indices[i, 0]
                right_entity = batch_indices[i, 2]
                print('Finding entities in embeddings...')
                print('Left entity: {}, {}'.format(left_entity, self.id2entity[left_entity]))
                print('Right entity: {}, {}'.format(right_entity, self.id2entity[right_entity]))

                new_x_batch_head[:, 0] = entity_list
                new_x_batch_tail[:, 2] = entity_list


                print('Shape: ', new_x_batch_head.shape)
                ...
                print('Deleting already existing triples')
                ...
                # print(new_x_batch_tail, scores_tail)
